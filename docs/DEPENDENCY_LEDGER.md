...
Watched dependencies for VibeGear2. The agent runs the **Dependency Upgrade Gate** at two trigger points:
...
- **Why watched**: internally maintained, pre-1.0, breaking changes possible on every release. VibeGear2 consumes the kit's portable + server modules.
