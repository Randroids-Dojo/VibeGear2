...
artefact is what ships. Vercel GitHub App handles PR previews. Required
secrets: `VERCEL_TOKEN`, `VERCEL_ORG_ID`, `VERCEL_PROJECT_ID`. Cloudflare
Pages, Netlify, GitHub Pages, and self-hosted were rejected (rationale in
the closing reason of dot `VibeGear2-research-choose-deploy-bcfb9148`).
